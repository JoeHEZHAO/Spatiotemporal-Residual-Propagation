...
class TSN(nn.Module):
    ...
    def _prepare_base_model(self, base_model):
        ...
        if 'resnet' in base_model or 'vgg' in base_model:
            ...
            # sys.path.append(os.path.join(cur_path, '../tf_model_zoo'))
    ...
    def _load_tsn_weight(self):
        """Loading caffe pre-trained weight from pth File
        """

        model_weights = '/home/zhufl/Temporal-Residual-Motion-Generation/tsn-pytorch/ucf101_rgb.pth'
        ...
        ''' Update with model_state, in case there are missing weights '''
